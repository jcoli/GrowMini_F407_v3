...
void on_service_0x03(String line_in);
void com_0x03_0x00(String line_in);
void com_0x03_0x01(String line_in);
void com_0x03_0x02(String line_in);
void com_0x03_0x03(String line_in);
void com_0x03_0x04(String line_in);
void com_0x03_0x05(String line_in);
void com_0x03_0x06(String line_in);
...
void on_service_0x03(String line_in){
    ...
    switch (i) {
        case 0x00:
            ...
            com_0x03_0x00(retMsg5[3]);
            break;    
        case 0x01:
            // Serial.println("Status Fan1 0x03 0x07");
            com_0x03_0x01(retMsg5[3]);
            break;    
        case 0x02:
            // Serial.println("Status Door 0x03 0x0D");
            com_0x03_0x02(retMsg5[3]);
            break;       
        case 0x03:
            // Serial.println("Status WiFi 0x03 0x21");
            com_0x03_0x03(retMsg5[3]);
            break;                        
        case 0x04:
            // Serial.println("Status BlueTooth 0x03 0x22");
            com_0x03_0x04(retMsg5[3]);
            break;
        case 0x05:
            // Serial.println("Service 0x03 0x05");
            com_0x03_0x05(retMsg5[3]);
            break; 
        case 0x06:
            // Serial.println("Status MQTT 0x03 0x21");
            com_0x03_0x06(retMsg5[3]);
            break;         
     }
}


void com_0x03_0x00(String command){
    level_irrig_l = bool(command? "1" : "0");
}    
void com_0x03_0x01(String command){
    level_irrig_ll = bool(command? "1" : "0");
}    
void com_0x03_0x02(String command){
    level_hum_l = bool(command? "1" : "0");
}    
void com_0x03_0x03(String command){
    level_hum_h = bool(command? "1" : "0");
 }    
void com_0x03_0x04(String command){
    wifi_connected = bool(command? "1" : "0");
    
}    
void com_0x03_0x05(String command){
    if (command.equals("1")){
        bt_connected = true;
        on_connect_bt();
    }else{
...
void com_0x03_0x06(String command){
    ha_connected = bool(command? "1" : "0");
}    
